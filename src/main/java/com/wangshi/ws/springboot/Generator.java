...
public class Generator {
    ...
    public static void main(String[] args) {
        // 包名
        String packageName = "com.wangshi.ws.springboot";
        boolean serviceNameStartWithI = false;//auth -> UserService, 设置成true: auth -> IUserService
        //把需要自动生成的表 放在这里!!
        generateByTables(serviceNameStartWithI, packageName, "Icemayor", "springboot", "user");
        generateByTables(serviceNameStartWithI, packageName, "Icemayor", "springboot", "teacher");
